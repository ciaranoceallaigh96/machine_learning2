...
#choose shuf set
	shuf /external_storage/ciaran/greml/indep_snps_full_dataset_new_snp_ids.prune.in | head -n 1000 > shuf10ksnps_"$1"_in_"$2"_"$3".txt
...
#choose top set
        ...
        /hpc/local/CentOS7/hers_en/software/plink-1.90/plink --prune --allow-no-sex --pheno $phenofile --bfile /home/ciaran/completed_big_matrix_binary_new_snps_ids --keep name_vector_train.txt --extract top10ksnps_"$1"_in_"$2"_"$3".txt --recode A --out train_raw_plink_top_"$1"_in_"$2"_"$3"

        /hpc/local/CentOS7/hers_en/software/plink-1.90/plink --prune --allow-no-sex --pheno $phenofile --bfile /home/ciaran/completed_big_matrix_binary_new_snps_ids --keep name_vector_test.txt --extract top10ksnps_"$1"_in_"$2"_"$3".txt --recode A --out test_raw_plink_top_"$1"_in_"$2"_"$3"
...
#choose top set
        ...
        head -n 10001 gwas_results_"$1"_in_"$2"_"$3".gsorted | awk '{if ($3 != "") print $3}'  > top10ksnps_"$1"_in_"$2"_"$3".txt #has header

        plink1.9 --1 --prune --allow-no-sex --pheno $phenofile --bfile/home/ciaran/completed_big_matrix_binary_new_snps_ids --keep name_vector_train.txt --extract top10ksnps_"$1"_in_"$2"_"$3".txt --recode A --out train_raw_plink_no_clump_"$1"_in_"$2"_"$3"

        plink1.9 --1 --prune --allow-no-sex --pheno $phenofile --bfile /home/ciaran/completed_big_matrix_binary_new_snps_ids --keep name_vector_test.txt --extract top10ksnps_"$1"_in_"$2"_"$3".txt --recode A --out test_raw_plink_no_clump_"$1"_in_"$2"_"$3"
