...
rbf_c = [2e-2, 1,int(2e+2),int(2e+4),int(2e+8)]
gamma_param = [0.002,0.0002] #ValueError: gamma < 0
...
max_iter=[1000,3000]
ridge_alpha = [0.0001, 1, 10, 100, 1000]
tolerance=[1e-3,1e-5,1e-1]
...
bootstrap = [False]
max_leaf_nodes = [50, 100, 500] #; max_leaf_nodes.append(x_train.shape[0])
...
param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs' : [50,100,200],'batch_size' : [16,32],'learning_rate' : [0.01, 0.001, 0.0001],'HP_L1_REG' : [1e-5,1e-6,1e-4, 1e-2, 1e-3],'HP_L2_REG' : [1e-8, 1e-3, float(0)], 'kernel_initializer' : ['glorot_uniform', 'glorot_normal', 'random_normal', 'random_uniform', 'he_uniform', 'he_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [200], 'rate' : [0.3, 0.5],'HP_OPTIMIZER' : ['RMSprop', 'Adadelta', 'Adamax', 'Adam', 'Adagrad', 'SGD']}
...
cnn_param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs':[100, 50],'batch_size' : [16,64,128], 'learning_rate' : [0.01, 0.05],'HP_L1_REG' : [0.001, 0.0001,0.00001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal', 'glorot_uniform', 'he_uniform', 'random_normal', 'random_uniform', 'he_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [100,200,1000], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['RMSprop', 'Adamax', 'Adam'], 'filters':[1,5],'strides':[1],'pool':[1,2,3],'kernel':[1,2,3]}
