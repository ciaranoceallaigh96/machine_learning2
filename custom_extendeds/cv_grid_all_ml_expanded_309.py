#python cv_grid_all_ml.py 70 /home/ciaran/arabadopsis/phenotypes/values_FT10.8424.dup.del /home/ciaran/completed_big_matrix_binary_new_snps_ids_first_10k.raw shuf FT10cv_n^Mnew_10k 10000 update on this command
...
rbf_c = [1, 2, 0.5]
gamma_param = [0.0002, 0.002,0.005] #ValueError: gamma < 0
svm_epsilon_param = [1]
epsilon_param = [0, 2e-5, 0.002]
...
svm_random_grid2 = {'C' : rbf_c, 'loss':loss_param, 'epsilon':svm_epsilon_param}
...
n_estimators = [5000, 7500] # Number of features to consider at every split
...
param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs' : [50,100,200],'batch_size' : [16,32, 128],'learning_rate' : [0.01, 0.001, 0.0001, 0.00001],'HP_L1_REG' : [1e-5,1e-6,1e-4, 1e-7, 1e-8],'HP_L2_REG' : [1e-8, 1e-3, float(0)], 'kernel_initializer' : ['he_uniform'],'activation' : [ 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [200, 100,1000], 'rate' : [float(0), 0.1, 0.3],'HP_OPTIMIZER' : ['Ftrl', 'RMSprop', 'Adadelta', 'Adamax', 'Adam', 'Adagrad', 'SGD']}
...
cnn_param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs':[100, 50],'batch_size' : [16,64,128], 'learning_rate' : [0.01, 0.0001, 0.001],'HP_L1_REG' : [0.001, 0.0001,0.00001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal', 'glorot_uniform', 'he_uniform', 'random_normal', 'random_uniform', 'he_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,3, 5],'units' : [100,200,1000], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['SGD','RMSprop', 'Adadelta', 'Adamax', 'Adam', 'Adagrad'], 'filters':[1,10],'strides':[1,10],'pool':[1,10],'kernel':[1,10]}
