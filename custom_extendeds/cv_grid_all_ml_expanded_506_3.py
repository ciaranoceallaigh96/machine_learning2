...
c_param = [int(2e+2),int(2e+4),int(2e+8)] 
rbf_c = [1]
gamma_param = [0.002] 
...
param_grid = {'network_shape':['funnel','long_funnel'], 'epochs' : [200, 300],'batch_size' : [16,32],'learning_rate' : [0.001],'HP_L1_REG' : [1e-6,1e-4],'HP_L2_REG' : [1e-8, 1e-3, 1e-1, float(0)], 'kernel_initializer' : ['glorot_uniform', 'glorot_normal'],'activation' : ['relu'],'HP_NUM_HIDDEN_LAYERS' : [2,3,5],'units' : [200, 100,1000], 'rate' : [float(0), 0.1, 0.3],'HP_OPTIMIZER' : ['Adamax', 'Adam', 'Adagrad', 'SGD']}
...
cnn_param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs':[100, 50],'batch_size' : [16,64], 'learning_rate' : [0.01, 0.001],'HP_L1_REG' : [0.00001],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal'],'activation' : ['tanh', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,3],'units' : [1000], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['SGD', 'RMSprop', 'Adamax'], 'filters':[5],'strides':[1],'pool':[1],'kernel':[2,3]}
