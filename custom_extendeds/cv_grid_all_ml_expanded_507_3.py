...
param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs' : [100],'batch_size' : [16,32, 128],'learning_rate' : [0.00001],'HP_L1_REG' : [0.001],'HP_L2_REG' : [1e-1, float(0)], 'kernel_initializer' : ['glorot_normal'],'activation' : ['relu'],'HP_NUM_HIDDEN_LAYERS' : [2,3],'units' : [1000], 'rate' : [float(0), 0.1],'HP_OPTIMIZER' : ['SGD']}
...
cnn_param_grid = {'network_shape':['long_funnel'], 'epochs':[50],'batch_size' : [64], 'learning_rate' : [0.0001, 0.001],'HP_L1_REG' : [0.001,0.00001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal'],'activation' : ['tanh', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [100,200,1000], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['Adagrad'], 'filters':[5],'strides':[1],'pool':[3],'kernel':[3]}
