...
c_param = [1] #check stability
rbf_c = [1] #at least one
gamma_param = [0.002]  
epsilon_param = [1] ##all the same, check stability
loss_param = ['epsilon_insensitive', 'squared_epsilon_insensitive'] #no diff check stability
kernel_param = ['rbf'] #check stability
...
n_estimators = [100,1000] #check stability
...
bootstrap = [False] #check stability
max_leaf_nodes = [100, 500] 
max_samples = [0.5, 0.9] #check stability
...
param_grid = {'network_shape':['brick', 'long_funnel'], 'epochs' : [50,100,200],'batch_size' : [16,32],'learning_rate' : [0.001],'HP_L1_REG' : [1e-5,1e-6,1e-4],'HP_L2_REG' : [1e-8, 1e-3, 1e-1], 'kernel_initializer' : ['glorot_uniform', 'random_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [3],'units' : [200, 1000], 'rate' : [float(0), 0.1],'HP_OPTIMIZER' : ['Adamax', 'Adam']}
...
cnn_param_grid = {'network_shape':['brick'], 'epochs':[100, 50],'batch_size' : [16,64], 'learning_rate' : [0.01, 0.001],'HP_L1_REG' : [0.0001,0.00001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal'],'activation' : ['tanh', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,3],'units' : [100], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['Adam'], 'filters':[5],'strides':[1],'pool':[1,2,3],'kernel':[3]}
