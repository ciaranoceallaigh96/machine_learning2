...
param_grid = {'network_shape':['funnel'], 'epochs' : [150],'batch_size' : [64],'learning_rate' : [10, 1, 0.1, 0.01, 0.001, 1e-4, 1e-5, 1e-6, 1e-7, 1e-8],'HP_L1_REG' : [1e-5],'HP_L2_REG' : [1e-8], 'kernel_initializer' : ['he_normal'],'activation' : ['relu'],'HP_NUM_HIDDEN_LAYERS' : [3],'units' : [1000], 'rate' : [0.1],'HP_OPTIMIZER' : ['Adamax']}
