...
n_estimators = [1000, 2000, 5000] # Number of features to consider at every split
...
param_grid = {'network_shape':['funnel'], 'epochs' : [100,200, 300],'batch_size' : [32],'learning_rate' : [0.01, 0.001],'HP_L1_REG' : [1e-2],'HP_L2_REG' : [1e-1, float(0)], 'kernel_initializer' : ['glorot_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [200, 100,1000], 'rate' : [float(0), 0.05],'HP_OPTIMIZER' : ['Adagrad']}
...
cnn_param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs':[100, 50],'batch_size' : [16,64,128], 'learning_rate' : [0.01, 0.1, 0.5],'HP_L1_REG' : [0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['he_uniform'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,3],'units' : [100,200,1000], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['Adamax', 'Adam'], 'filters':[10, 20, 50],'strides':[1],'pool':[1,2,10],'kernel':[10, 20, 50]}
