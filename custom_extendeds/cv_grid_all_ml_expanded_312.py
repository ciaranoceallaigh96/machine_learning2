...
c_param = [0.02, 0.01, 0.05] #can be negative #We found that trying exponentially growing sequences of C and γ is a practical method to identify good parameters https://www.csie.ntu.edu.tw/~cjlin/papers/guide/guide.pdf
rbf_c = [1, 5, int(2e+2),int(2e+4),int(2e+8)]
gamma_param = [0.002,0.01, 0.0002] #ValueError: gamma < 0
...
min_samples_split = [2, 10, 100, 50] # Minimum number of samples required at each leaf node
...
param_grid = {'network_shape':['brick','long_funnel'], 'epochs' : [50,100,200],'batch_size' : [32],'learning_rate' : [0.01, 0.005, 0.05],'HP_L1_REG' : [1e-5,1e-6,1e-4],'HP_L2_REG' : [float(0)], 'kernel_initializer' : ['glorot_uniform', 'glorot_normal', 'he_uniform'],'activation' : ['tanh', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [200, 100,1000], 'rate' : [0.1],'HP_OPTIMIZER' : ['RMSprop', 'Adamax', 'Adam', 'Adagrad', 'SGD']}
...
cnn_param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs':[100, 50],'batch_size' : [16,64,128], 'learning_rate' : [0.01, 0.0001, 0.001],'HP_L1_REG' : [0.001, 0.0001,0.00001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal', 'glorot_uniform', 'he_uniform', 'random_normal', 'random_uniform', 'he_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,10],'units' : [100,200,1000], 'rate' : [float(0), 0.1, 0.5],'HP_OPTIMIZER' : ['SGD', 'RMSprop', 'Adamax', 'Adam', 'Adagrad'], 'filters':[1,10],'strides':[1,10],'pool':[1,10],'kernel':[1,10]}
