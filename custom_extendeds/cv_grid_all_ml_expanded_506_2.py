...
param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs' : [200, 300],'batch_size' : [16,32, 128],'learning_rate' : [0.001],'HP_L1_REG' : [1e-5,1e-6,1e-4, 1e-3],'HP_L2_REG' : [1e-8, 1e-3, 1e-1, float(0)], 'kernel_initializer' : ['glorot_uniform', 'glorot_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,3,5],'units' : [200, 100,1000], 'rate' : [float(0), 0.1, 0.3],'HP_OPTIMIZER' : ['RMSprop', 'Adamax', 'Adam', 'Adagrad', 'SGD']}
