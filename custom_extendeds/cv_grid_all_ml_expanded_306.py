...
svm_random_grid2 = {'C' : c_param, 'loss':loss_param, 'epsilon':svm_epsilon_param}
...
alpha = [0.01, 0.1, 1, 10, 100, -1, -10, -100]
max_iter=[1000,3000]
...
n_estimators = [1000, 5000] # Number of features to consider at every split
