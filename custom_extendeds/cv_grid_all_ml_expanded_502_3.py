...
c_param = [0.01, 0.005] #can be negative #We found that trying exponentially growing sequences of C and γ is a practical method to identify good parameters https://www.csie.ntu.edu.tw/~cjlin/papers/guide/guide.pdf
rbf_c = [1]
gamma_param = [0.2,0.01] #ValueError: gamma < 0
epsilon_param = [2e-3,1,0]
...
cache_size=[100,200]#Specify the size of the kernel cache (in MB).
degree = [1,2]
...
param_grid = {'network_shape':['funnel','long_funnel'], 'epochs' : [50],'batch_size' : [16, 128],'learning_rate' : [0.0001],'HP_L1_REG' : [1e-6, 0.1],'HP_L2_REG' : [1e-8, 1e-3], 'kernel_initializer' : ['glorot_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2,3],'units' : [200,1000], 'rate' : [float(0), 0.1, 0.3],'HP_OPTIMIZER' : ['RMSprop', 'Adadelta', 'Adamax', 'Adam', 'Adagrad', 'SGD']}
...
cnn_param_grid = {'network_shape':['long_funnel'], 'epochs':[100, 50],'batch_size' : [64], 'learning_rate' : [0.001],'HP_L1_REG' : [0.0001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_normal', 'glorot_uniform', 'he_uniform'],'activation' : ['tanh', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [100,200,1000], 'rate' : [float(0), 0.5],'HP_OPTIMIZER' : ['Adadelta','Adagrad'], 'filters':[5],'strides':[1,2,3],'pool':[1],'kernel':[1,2,3]}
