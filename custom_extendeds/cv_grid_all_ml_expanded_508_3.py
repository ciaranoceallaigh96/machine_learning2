...
param_grid = {'network_shape':['long_funnel'], 'epochs' : [50],'batch_size' : [32, 128],'learning_rate' : [0.001],'HP_L1_REG' : [1e-5,1e-6,1e-4],'HP_L2_REG' : [1e-8, 1e-3, float(0)], 'kernel_initializer' : ['glorot_uniform', 'glorot_normal', 'random_uniform', 'he_uniform'],'activation' : ['relu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [200], 'rate' : [float(0), 0.1],'HP_OPTIMIZER' : ['Adam']}
...
cnn_param_grid = {'network_shape':['brick', 'funnel','long_funnel'], 'epochs':[100, 50],'batch_size' : [16,64,128], 'learning_rate' : [0.0001, 0.001],'HP_L1_REG' : [0.0001,0.00001,0],'HP_L2_REG' : [0, 0.001,0.00001],'kernel_initializer' : ['glorot_uniform', 'he_uniform'],'activation' : ['tanh', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [2],'units' : [100,200], 'rate' : [float(0), 0.1],'HP_OPTIMIZER' : ['RMSprop', 'Adam'], 'filters':[5],'strides':[1],'pool':[1],'kernel':[2]}
