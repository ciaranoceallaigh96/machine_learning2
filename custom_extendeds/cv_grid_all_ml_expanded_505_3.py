...
param_grid = {'network_shape':['brick', 'long_funnel'], 'epochs' : [50,100,200],'batch_size' : [16,32],'learning_rate' : [0.01, 0.001],'HP_L1_REG' : [1e-5,1e-6,1e-4],'HP_L2_REG' : [1e-8, 1e-3, 1e-1], 'kernel_initializer' : ['glorot_uniform', 'random_normal'],'activation' : ['tanh', 'relu', 'elu'],'HP_NUM_HIDDEN_LAYERS' : [3],'units' : [200, 1000], 'rate' : [float(0), 0.1],'HP_OPTIMIZER' : ['Adamax', 'Adam']}
