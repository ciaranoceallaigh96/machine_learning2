...
SVM_NCV = NestedCV(model=LinearSVR(), params_grid=svm_random_grid2, outer_kfolds=2, inner_kfolds=2, n_jobs = 2,cv_options={'sqrt_of_score':False,'randomized_search':True, 'randomized_search_iter':3, 'recursive_feature_elimination':False, 'metric':sklearn.metrics.r2_score, 'metric_score_indicator_lower':False})
