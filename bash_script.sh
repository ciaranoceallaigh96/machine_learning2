...
then
        ...
        plink1.9 --prune --allow-no-sex --pheno $phenofile --bfile /home/ciaran/completed_big_matrix_binary_new_snps_ids --clump-kb 250 --clump-p1 0.0005 --clump-p2 0.001 --clump-r2 0.1 --clump mlma_results_"$1"_in_"$2"_"$3".gsorted --out mlma_results_clumped_"$1"_in_"$2"_"$3"
